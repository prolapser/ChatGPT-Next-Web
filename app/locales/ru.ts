...
const ru: PartialLocaleType = {
 ...
 `,
  ...
  Export: {
    ...
    IncludeContext: {
      Title: "Включить контекст роли",
      SubTitle: "Показывать ли контекст роли в сообщениях",
    },
    Steps: {
      Select: "Выбрать",
  ...
  Settings: {
    ...
    Mask: {
      ...
      Builtin: {
        ...
        SubTitle: "Скрыть встроенные роли во всех списках масок",
      },
    },
    Prompt: {
      Disable: {
  ...
  Mask: {
    ...
    EditModal: {
      Title: (readonly: boolean) =>
        `Редактирование предустановленной роли ${
    ...
    Config: {
      ...
      Share: {
        ...
        SubTitle: "Создать прямую ссылку на эту роль",
  ...
  NewChat: {
    ...
    Title: "Выберите роль",
    SubTitle: "Начните сейчас, выбрав роль для ИИ",
    More: "Показать все",
  },
